...
#define MQTT_TEST_SERVER_HOST "mqtttest.iot"
...
//---------------------------
#define IPSET_STATIC { 192, 168, 10, 50 }
...
PubSubClient client(mqtt_server_host, 8883, wifiClient);
