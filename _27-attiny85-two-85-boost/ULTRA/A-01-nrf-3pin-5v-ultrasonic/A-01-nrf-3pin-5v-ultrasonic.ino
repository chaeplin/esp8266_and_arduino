...
#define TRIG 4  // A2 // PIN 3 // D 4
#define ECHO 3  //  A3 // PIN 2 // D 3

Average<float> ave(10);

Ultrasonic ultrasonic(TRIG, ECHO, 30000); // (Trig PIN,Echo PIN)
...
int16_t readData1() {
  ...
  if (ave.mean() < 10) {
    return ((67870.0 / (10 - 3.0)) - 40.0);
  } else {
    return ((67870.0 / (ave.mean() - 3.0)) - 40.0);
  }
}
*/
