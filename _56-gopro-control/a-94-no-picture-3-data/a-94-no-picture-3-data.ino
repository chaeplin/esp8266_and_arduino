...
void parseMqttMsg(String receivedpayload, String receivedtopic) {
  ...
  if ( receivedtopic == substopic[0] )
  {
    ...
    if (root.containsKey("data3"))
    {
      solar_data.data5 = root["data3"];
    }
    lastTime = millis();
  }
      ...
      else
      {
        if (timeStatus() != timeNotSet)
        {
          ...
          if (
            ...
            curr_data.data5 != solar_data.data5
          )
          {
            displayData();
            curr_data.data1 = solar_data.data1;
          ...
          if (
            ...
            curr_data.data6 != solar_data.data6
          )
          {
            displayData2();
            curr_data.data3 = solar_data.data3;
...
void displayData()
{
  ...
  lcd.print("    ");
  lcd.setCursor(4, 2);
  lcd.print(solar_data.data2, 3);

  lcd.setCursor(12, 2);
  lcd.print("    ");
  lcd.setCursor(12, 2);
  lcd.print(solar_data.data5, 3);
