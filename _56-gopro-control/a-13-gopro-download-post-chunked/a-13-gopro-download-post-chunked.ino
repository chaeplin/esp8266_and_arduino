  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (x) {
      ...
      if (timeStatus() == timeSet) {
        ...
        /*
          value_timestamp = 1461020078;
          value_nonce     = "OJ2ryy8BXj6QJHBB2GuKVNtCep0mJdyHDdgo2brlvQ";
        */
...
/*---*/
String get_hash_str(String content_more, String content_last, int positionofchunk, int get_size) {
...
String make_para_string(String hashStr = "0") {
  ...
  switch (twitter_phase) {
    ...
    case 3:
      para_string += URLEncode(UPLOAD_COMMAND);
      para_string += "=" ;
      para_string += URLEncode(UPLOAD_CMD_APPEND);
      para_string += "&";
  ...
  switch (twitter_phase) {
    ...
    case 3:
      para_string += "&";
      para_string += UPLOAD_MEDIA_SEG_INDX;
      para_string += "=";
      para_string += chunked_no;
      break;
...
void tweet_append() {
  ...
  String content_more = "--00Twurl323303902063163092lruwT99\r\n";
  content_more += "Content-Disposition: form-data; name=\"command\"\r\n\r\n";
  content_more += "APPEND\r\n";
  content_more += "--00Twurl323303902063163092lruwT99\r\n";
  ...
  content_more += "--00Twurl323303902063163092lruwT99\r\n";
  content_more += "Content-Disposition: form-data; name=\"media\"; filename=\"" + gopro_file + "\"\r\n" ;
  content_more += "Content-Type: application/octet-stream\r\n\r\n";

  String content_last = "\r\n--00Twurl323303902063163092lruwT99--\r\n";
  ...
  content_header += "Content-Type: multipart/form-data, boundary=\"00Twurl323303902063163092lruwT99\"\r\n";
