// Using Sonoff wifi switch, esp-studyroomlight,  80MHz, 1M / 64K
...
const char* subscribe_topic = "light/studyroomlight";
const char* reporting_topic = "light/studyroomlight/report";
const char* status_topic    = "light/studyroomlight/status";
...
void wifi_connect()
{
  if (WiFi.status() != WL_CONNECTED)
  {
    ...
    WiFi.hostname("esp-studyroomlight");
...
void ArduinoOTA_config()
{
  ...
  ArduinoOTA.setHostname("esp-studyroomlight");
...
void setup()
{
  ...
  getResetInfo = "hello from studyroomlight ";
