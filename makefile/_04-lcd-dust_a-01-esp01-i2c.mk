...
SKETCH ?= $(HOME)/esp8266_and_arduino/_04-lcd-dust/a-01-esp01-i2c/a-01-esp01-i2c.ino
LIBS ?= $(ESP_LIBS)/ESP8266WiFi \
$(ESP_LIBS)/ESP8266mDNS \
$(ESP_LIBS)/ArduinoOTA \
$(ESP_LIBS)/Wire \
$(HOME)/esp8266_libraries/pubsubclient/src \
$(HOME)/esp8266_libraries/LiquidCrystal_I2C \
$(HOME)/esp8266_libraries/PietteTech_DHT-8266 \
$(HOME)/esp8266_libraries/Rtc_by_Makuna \
...
# OTA parameters
#ESP_ADDR ?= esp-lcddust.local
ESP_ADDR ?= 192.168.10.61
ESP_PORT ?= 8266
#ESP_PWD ?= xxxxx
